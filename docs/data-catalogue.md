...
| World Bank WDI manufacturing and high-tech | `manuf_va.json`, `hitech_exports.json` | 1960–2024 (USA manufacturing 1997–2021 only) | `manuf_va`, `hitech_exports` — the Industry view's modern series and roses; inputs for the capability-wave package | NV.IND.MANF.CD, TX.VAL.TECH.CD, current US$; the viewer reads shares of the reporting total |
