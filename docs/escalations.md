...
**The three falsifiers, measured** (`node scripts/corridor-fit.mjs`; p is the full-sample fitted probability, pct its percentile in that template's sample):
